      ...
      <div>
        ...
        <b.Modal show={this.state.showModal} onHide={this.close}>
          ...
          <b.Modal.Body>
            ...
            <p>Your people can be a miners, lumberjacks, farmers and hunters. Each of them can give you resources. You can see list of resources on the top right corner. In the top of screen you can see the rate of resources extraction</p>
            <p>It will take some resources to teach idle man to worker. Hover on unit to learn how much.</p>
            ...
            <p>You have some mortality level (panel "Info" on left side). Your people will die faster without food (obviously)</p>
            <p>You can build ARMY for some aggressive actions against neighbors. Just recruit them and press "WAR" button. In the war you can take away some resources from enemies...or you can lose all your soldiers. Remember, that army will spend a money (the bigger army, the more money)</p>
            <h4>Controls</h4>
